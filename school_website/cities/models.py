...
class QuestionManager(models.Manager):
    def question_category(self, category):
        return self.filter(title__icontains=category)
...
class Question(models.Model):
    ...
    objects = models.Manager()
    category_objects = QuestionManager()
...
class QuestionGenerator(models.Model):
    ...
    '''
    def __init__(self,category, question_predicate,question_subject_list,question_choices_list, num_questions_to_select=10,
